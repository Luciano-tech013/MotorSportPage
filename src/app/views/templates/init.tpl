<section>
    ...
    {if !isset($smarty.session.AUTH.IS_LOGGED)}
        ...
        <a href="account" class="btn btn-primary">Registrarte</a> con una cuenta en el sistema, y asi poder usarla para interes propio. Nuestro objetivo es que la herramienta pueda intuirte en tu estudio de automóviles. Para eso brindamos dos tablas: Una para la informacion del auto, y otra para la informacion de la categoria. En estas tablas podras agregar, eliminar y editar filas. Si no te interesa este servicio, solo puedes ver nuestras tablas que nosotros preparamos y usamos dia a dia. Por ejemplo:</p>
    {/if}
</section>